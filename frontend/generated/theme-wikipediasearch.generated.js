...
import stylesCss from 'themes/wikipediasearch/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_wikipediasearch_componentCss']) {
    
    document['_vaadintheme_wikipediasearch_componentCss'] = true;
  }
