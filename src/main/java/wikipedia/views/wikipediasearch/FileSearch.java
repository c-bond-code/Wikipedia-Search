...
class FileSearch {
    ...
    public static ArrayList<String> getPathGUI() throws IOException {
        ...
        WikipediaSearch.loadSpellChecker();
        WikipediaSearch.loadReducer(filePaths);
        return filePaths;
    ...
    public static ArrayList<String> getPath() throws IOException {
        FileSearch ff = new FileSearch();
        String file = "src/main/java/wikipedia/wiki_files";
